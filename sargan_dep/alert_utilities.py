def send_file_via_email(email_subject, email_body, file_path, from_email="hbwalker007@gmail.com", to_email="hans21@bu.edu"):
# Python code to illustrate Sending mail with attachments 
    ...
    # Authentication 
    s.login(from_email, "insert_password") 
...
def send_image_via_email(email_subject, email_body, image_file_path, from_email="hbwalker007@gmail.com", to_email="hans21@bu.edu"):
    """
...
def send_images_via_email(email_subject, email_body, image_file_paths, sender_email="hbwalker007@gmail.com", recipient_emails=["hans21@bu.edu"]):
    """
    Send image via email
    """
    ...
    # Authentication 
    s.login(sender_email, "insert_password") 
